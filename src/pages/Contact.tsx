...
const contactDetails = [
  ...
  { label: 'Call Us', value: '+1 (469) 910 4144', href: 'tel:+12345678900', icon: <Phone size={18} color="#0891b2" />, bg: 'rgba(8,145,178,0.08)' },
  { label: 'Location', value: 'Dallas, TX — Remote Worldwide', href: '#', icon: <MapPin size={18} color="#7c3aed" />, bg: 'rgba(124,58,237,0.08)' },
